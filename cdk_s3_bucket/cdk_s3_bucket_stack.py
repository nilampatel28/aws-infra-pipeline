...
class CdkS3BucketStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        # Create an S3 bucket
        bucket = s3.Bucket(self, "demo-cdk-code-catalyst-spandan",  # Changed from XXXXXXXXXXXXX to a meaningful ID
            # Optional configurations
            bucket_name="spandan13-testing-test-doc-bukall",  # Changed from XXXXXXXXXXXXX to a meaningful name
